...
import npuzzle.behaviors.{ Position, Distance }
...
class DistanceTest {
  ...
  @Test
  def determineDistanceBetweenTwoMatchingBoardsToBeZero_3x3(): Unit = {
  ...
  @Test
  def determineDistanceOfOneTileDifferenceToBeOne_3x3(): Unit = {
    case object dist extends Distance {
      case object pos extends Position
      override type _Position = Position
      override val position: Position = pos 
  ...
  @Test
  def determineDistanceOfTwoTileDifferenceToBeTwo_3x3(): Unit = {
    case object dist extends Distance {
      case object pos extends Position
      override type _Position = Position
      override val position: Position = pos 
  ...
  @Test
  def determineDistanceOfThreeTileDifferenceToBeThree_3x3(): Unit = {
    case object dist extends Distance {
      case object pos extends Position
      override type _Position = Position
      override val position: Position = pos 
