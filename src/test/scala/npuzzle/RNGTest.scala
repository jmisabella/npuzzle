...
class RNGTest {
  ...
  @Test
  def giveConsistentIntegerResultsForGivenSeed(): Unit = {
    val seed = 743897
  ...
  @Test
  def giveConsistentLongIntegerResultsForGivenSeed(): Unit = {
    val seed = 57
    val r1: RNG = RNG.RandomSeed(seed)
  ...
  @Test
  def giveConsistenBooleanResultsForGivenSeed(): Unit = {
    val seed = 80
    val r1: RNG = RNG.RandomSeed(seed)
  ...
  @Test
  def provideConsistentBoundedPositiveIntegersWhichAreNonNegativeAndWithinBounds(): Unit = {
    val seed = 5431
    val upperBound = 200
